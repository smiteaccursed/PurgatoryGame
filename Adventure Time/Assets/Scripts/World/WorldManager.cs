...
public class WorldManager : MonoBehaviour
{
    ...
    [Header("Ink JSON")]
    [SerializeField] private TextAsset structJSON;
    [SerializeField] private TextAsset hubstructJSON;
    [SerializeField] private TextAsset ruleJSON;
            ...
            for (int y = -viewDistance; y <= viewDistance; y++)
            {
                ...
                if (!chunks.ContainsKey(chunkCoord))
                {
                    ...
                    if (rng.Next(0, 5) == 0) 
                    {
                        ...
                        structures.GetRndStruct(localSeed).SpawnStruct(chunkCoord, 2);
