...
public class SaveSystem : MonoBehaviour
{
    ...
    public PlayerData GetAllData()
    {
        ...
        playerData.currentPassive = DataManager.Instance.currentPassive;
        playerData.currentActive = DataManager.Instance.currentActive;
...
public class PlayerData
{
    ...
    public List<int> currentActive;
    public List<int> currentPassive;
